...
public class About {
	...
	private void initialize() {
		...
		txtrThisAppIs.setText("This app is Created By Raghu and Rahul ");
		...
		txtrH.setText("Roll Number :- 10 & 27");
		...
		txtrUserNameIqra.setText("User Name: rahul");
		...
		txtrPasswordIqra.setText("Password: rahul");
